...
class PekerjaViewModel extends BaseViewModel {
  ...
  void onDelete(PekerjaModel model) async {
        ...
        child: WBottomSheet(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Anda yakin akan menghapus ${model.nama}?'),
            ],
          ),
        ));
    ...
    isLoading = true;
    final response = await repository.delete(idPekerja: model.id);
